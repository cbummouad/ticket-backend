 ...
 *               solde_autorise:
 *                 type: number
 *                 description: Authorized balance
 *               qr_code:
 *                 type: string
 *                 description: QR code
 *               id_rpp:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/:id/roles', auth, userController.assignRoleToUser);
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.delete('/:id/roles/:roleId', auth, userController.removeRoleFromUser);
