 ...
 *               $ref: '#/components/schemas/Error'
 */
router.get('/slug/:slug', auth, roleController.getRoleBySlug);
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.get('/:id/users', auth, roleController.getUsersWithRole);
 ...
 *       400:
 *         description: Bad request - missing userId or roleId
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/Error'
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/assign', auth, roleController.assignRoleToUser);
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/remove', auth, roleController.removeRoleFromUser);
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.get('/user/:userId', auth, roleController.getUserRoles);
